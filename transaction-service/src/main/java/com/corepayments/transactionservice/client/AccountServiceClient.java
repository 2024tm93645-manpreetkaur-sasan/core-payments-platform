...
public interface AccountServiceClient {
    ...
    AccountResponse debit(@PathVariable Long id, @RequestBody AmountRequest amount);

    @PostExchange("/accounts/{id}/credit")
    AccountResponse credit(@PathVariable Long id, @RequestBody AmountRequest amount);
}